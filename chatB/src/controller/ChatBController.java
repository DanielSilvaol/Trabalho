...
public class ChatBController extends HttpServlet {
    ...
    private static final String RESPOSTA_NAO_ENCONTRADA = "Desculpe, mas não tenho a resposta para sua pergunta! Você pode reformular a sua pergunta?";
    private static final String ATT_PERG = "pergunta";
